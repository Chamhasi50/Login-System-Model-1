...
welcome_label = ck.CTkLabel(login_frame, text='  Ets Dankanka S.A  ', text_color='#115d6c', font=('Helvetica', 35, 'bold', 'underline'), bg_color='#fff').place(x=590, y=20)
...
user_entry = ck.CTkEntry(login_frame, font=('Ariel', 17, 'bold'), text_color='gray', width=400, height=40, placeholder_text='Agent T000', border_width=1, border_color='#115d6c', bg_color='#fff', fg_color='#fff')

pass_entry = ck.CTkEntry(login_frame, font=('Ariel', 17, 'bold'), text_color='gray', show='⏣', width=400, height=40, placeholder_text='Mot De Passe', border_width=1, border_color='#115d6c', bg_color='#fff', fg_color='#fff')

user_entry.place(x=550, y=150)
pass_entry.place(x=550, y=200)

# ------------------------------ Les button pour le login page.
login_button = ck.CTkButton(login_frame, text='Se connecter', text_color='#e0f2f1', font=('Ariel', 20, 'bold'), width=400, height=50, bg_color='#fff', fg_color='#115d6c',hover_color='#115d6c', command=check).place(x=550, y=250)

logout_button = ck.CTkButton(login_frame, text='Changer le mot de passe', text_color='#e0f2f1', font=('Ariel', 20, 'bold'), width=400, height=50, bg_color='#fff', fg_color='#115d6c', hover_color='#115d6c', command= change).place(x=550, y=310)
...
welcome_label = ck.CTkLabel(change_frame, text='  Ets Dankanka S.A  ', text_color='#854ddc', font=('Helvetica', 35, 'bold', 'underline'), bg_color='#fff').place(x=590, y=20)
...
new_user_entry = ck.CTkEntry(change_frame, font=('Ariel', 17, 'bold'), width=400, height=40, border_width=1, border_color='#854ddc', text_color='gray', placeholder_text='Agent T000', bg_color='#fff', fg_color='#fff')

new_pass_entry = ck.CTkEntry(change_frame, font=('Ariel', 17, 'bold'), show='⏣', width=400, height=40, border_width=1, border_color='#854ddc',text_color='gray', placeholder_text='Nouveau Mot De Passe', bg_color='#fff', fg_color='#fff')

pass_conf_entry = ck.CTkEntry(change_frame, font=('Ariel', 17, 'bold'), show='⏣', width=400, height=40, border_width=1, border_color='#854ddc',text_color='gray', placeholder_text='Confirmer Le Mot De Passe', bg_color='#fff', fg_color='#fff')
...
change_button = ck.CTkButton(change_frame, text='Changer le mot de passe', text_color='#f7f0fa', font=('Ariel', 20, 'bold'), width=400, height=50, bg_color='#fff', fg_color='#854ddc',hover_color='#854ddc',command=insert).place(x=550, y=310)

have_account = ck.CTkButton(change_frame, text="Ce connecter à un compte existent", text_color='#854ddc', font=('Helvetica', 15, 'underline'), fg_color='#fff', bg_color='#fff', hover_color='#fff', command=exists).place(x=630, y=375)
