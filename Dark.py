...
def show(): # Cacher tout les caractaire afficher.
  show_hide_button = ck.CTkButton(login_frame, width=30, corner_radius=8, text='', image=hide_image, command=hide, bg_color='#202225', fg_color='#202225', hover_color='#202225')
...
def hide(): # Afficher tout les caractaires cacher.
  show_hide_button = ck.CTkButton(login_frame, width=30, corner_radius=8, text='', image=show_image, command=show, bg_color='#202225', fg_color='#202225', hover_color='#202225')
  show_hide_button.place(x=900, y=205)
  pass_entry.configure(show='⏣') # Remetre en symbole.

# ---------------------------------------- The Main Frames
login_frame = ck.CTkFrame(log, width=990, height=488, bg_color='#18191c', fg_color='#202225')
change_frame = ck.CTkFrame(log, width=990, height=488, bg_color='#18191c', fg_color='#202225')
...
# ---------------------------------------- The Right Window (User credantials)

lock_img = ck.CTkImage(Image.open(file_path + 'Images/login.png'), size=(450, 470))
lock_lab = ck.CTkLabel(login_frame, image = lock_img, bg_color='#202225', text='').place(x=30, y=10)
...
face_lab = ck.CTkButton(log, image = facebook_img, text='', width=50,fg_color='#202225', bg_color='#202225', hover_color='#f7f0fa', command=lambda:facebook_page()).place(x=552, y=430)
x_lab = ck.CTkButton(log, image = x_img, text='', width=50,fg_color='#202225', bg_color='#202225', hover_color='#f7f0fa', command=lambda:tiwitter_page()).place(x=620, y=430)
insta_lab = ck.CTkButton(log, image = insta_img, text='', width=50,fg_color='#202225', bg_color='#202225', hover_color='#f7f0fa', command=lambda:instagram_page()).place(x=692, y=430)
link_lab = ck.CTkButton(log, image = link_img, text='', width=50,fg_color='#202225', bg_color='#202225', hover_color='#f7f0fa', command=lambda:linkedin_page()).place(x=763, y=430)
you_lab = ck.CTkButton(log, image = you_img, text='', width=50,fg_color='#202225', bg_color='#202225', hover_color='#f7f0fa', command=lambda:youtube_page()).place(x=833, y=430)
...
user_entry = ck.CTkEntry(login_frame, font=('Ariel', 17, 'bold'), text_color='#e0f2f1', width=400, height=40, placeholder_text='Agent T000', border_width=1, border_color='#115d6c', bg_color='#202225', fg_color='#202225')

pass_entry = ck.CTkEntry(login_frame, font=('Ariel', 17, 'bold'), text_color='#e0f2f1', show='⏣', width=400, height=40, placeholder_text='Mot De Passe', border_width=1, border_color='#115d6c', bg_color='#202225', fg_color='#202225')
